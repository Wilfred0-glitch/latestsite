        ...
        toast({
          ...
          description: (
            <div className="flex items-center space-x-2">
              ...
              <span>Thank you! We've received your inquiry and will get back to you within 24 hours.</span>
            </div>
          ),
          variant: "default"
        });
              ...
              <form onSubmit={handleMainContact}>
                <div className="row g-3">
                  ...
                  <div className="col-12">
                    <button 
                      type="submit" 
                      className={`btn btn-modern btn-primary-modern w-100 ${submitStatus === 'success' ? 'success-state' : ''}`}
